...
export const BrandAnalyzer: React.FC<BrandAnalyzerProps> = ({ 
  ...
  const handleRunAnalysis = () => {
    ...
    setTimeout(() => {
      setProgressMessage('Parsing HTML metadata and subpage content...');
    }, 800);

    setTimeout(() => {
      setProgressMessage('Extracting brand tone and keyword clusters...');
    }, 1600);
      ...
      <div className="bg-[#141416] border border-[#26262a] rounded-2xl p-6 sm:p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        <div>
          ...
          <p className="text-neutral-400 text-sm max-w-2xl mt-1">
            Dedicated client profile, connected social accounts, website crawling index, and strategic content pillars.
          </p>
        </div>
        ...
        <div className="flex items-center space-x-3">
          ...
          >
            ...
            <span>{isAnalyzing ? 'Analyzing...' : 'Re-Analyze Site'}</span>
          </button>
        </div>
      </div>
